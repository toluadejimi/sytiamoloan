    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="card card-signin p-3 my-5">
                <div class="card-body">
					<img class="logo" src="{{asset('public/image/logo.png')}}" width="150px" height="auto">
            ...
            <div class="form-group row mb-0">
                 <div class="col-md-12">
                                <a class="btn btn-light" href="https://sytiamoportal.com/sytiamo-1.3.4.apk" role="button">
                                     Download Andriod Agent Mobile App 
                                </a>
                            </div>
            </div>
        </div>
