...
<div class="collapse" id="users" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
	<nav class="sb-sidenav-menu-nested nav">
		...
		<a class="nav-link" href="{{ route('users.export_alluser') }}">{{ _lang('Export All Users') }}</a>
...
<div class="collapse" id="loans" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
	<nav class="sb-sidenav-menu-nested nav">
		...
		<a class="nav-link"  href="{{ route('sort.pending') }}">{{ _lang('Pending Loans') }} 	{!! xss_clean(request_count('pending_loans',true)) !!}</a>
		<a class="nav-link" href="{{ route('sort.approved') }}">{{ _lang('Approved Loans') }}</a>
		...
		<a class="nav-link" href="{{ route('loans.manager_request_view') }}">{{ _lang('Request for Disbursment') }}</a>
		<a class="nav-link" href="{{ route('loans.manager_repayments') }}">{{ _lang('Disbursment Repayment') }}</a>
		<a class="nav-link" href="{{ route('loans.uncompleted') }}">{{ _lang('Owing Customers') }}</a>
	</nav>
</div>
...
<a class="nav-link" href="{{ route('reports.afo') }}">
	<div class="sb-nav-link-icon"><i class="bi bi-book-fill"></i></div>
	AFO Report
</a>
...
<div class="collapse" id="systemUsers" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
	<nav class="sb-sidenav-menu-nested nav">
		<a class="nav-link" href="{{ route('system_users.index') }}">{{ _lang('All Agent') }}</a>
		<a class="nav-link" href="{{ route('system_users.create') }}">{{ _lang('Create Agent') }}</a>
