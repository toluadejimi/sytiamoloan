    ...
    <div class="col-md-9">
        <div class="tab-content">
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <td colspan="2" class="text-center"><img class="thumb-image-sm img-thumbnail"
                                        src="{{ url('public/uploads/media/'.$user->profile_picture)}}"></td>
                            </tr>
                            <tr>
                                <td>Customer Name</td>
                            ...
                            <tr>
                             ...
                             <tr>
                                <td>{{ _lang('Nearest Bus Stop') }}</td>
                                <td>{{ $user->hbus_stop }}</td>
                            </tr>
                              <tr>
                                <td>{{ _lang('Shop Address') }}</td>
                            ...
                            <tr>
                             ...
                             <tr>
                                 <td>Guarantor ID/Image</td>
                                <td colspan="2" class="text-center"><img class="thumb-image-sm img-thumbnail"
                                        src="{{ url('public/uploads/media/'.$user->gpicture)}}"></td>
                            </tr>
                            ...
                            <!--</tr>-->
                            <!-- <tr>-->
                            <!--    <td>Guarantor 2 Phone Number</td>-->
                            <!--    <td>{{ $user->gphone2 }}</td>-->
                            <!--</tr>-->
                        </table>
                            <div class="form-group row">
                                <div class="col-xl-9 offset-xl-1">
                                    <a href="{{ route('users.edit', $user['id']) }}" class="btn btn-primary"><i class="icofont-check-circled"></i> Edit</a>
                                </div>
                            </div>
                    </div>
                </div>
            ...
            <div id="sms" class="tab-pane">
                <div class="card">
                    <div class="card-header">
                        <span class="header-title">Send SMS to Borrower</span>
                    </div>

                    <div class="card-body">
                    <form method="post" class="validate" autocomplete="off" action="{{ route('users.send') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label">{{ _lang('User Mobile') }}</label>
                                        <input type="text" class="form-control" name="phone" value="{{ $user->phone }}" required="" readonly>
                                    </div>
                                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <span class="header-title">Send SMS to First Guarantor</span>
                    </div>
                    ...
                    <form method="post" class="validate" autocomplete="off" action="{{ route('users.send') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label">{{ _lang('User Mobile') }}</label>
                                        <input type="text" class="form-control" name="phone" value="{{ $user->gphone }}" required="" readonly>
                                    </div>
                                </div>
                 ...
                 <div class="card">
                    <div class="card-header">
                        <span class="header-title">Send SMS to Second Guarantor</span>
                    </div>
                    ...
                    <form method="post" class="validate" autocomplete="off" action="{{ route('users.send') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label">{{ _lang('User Mobile') }}</label>
                                        <input type="text" class="form-control" name="phone" value="{{ $user->gphone2 }}" required="" readonly>
                                    </div>
                                </div>
