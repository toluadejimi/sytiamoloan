...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" class="" autocomplete="off" id="" action="{{ action('SystemUserController@update', $id) }}" enctype="multipart/form-data">
	{{ csrf_field()}}
	...
	<div class="row p-2">
        ...
        <div class="col-md-6">
			<div class="form-group">
				...
				<select class="form-control auto-select select2 mselect" data-selected={{ $encodeList }} name="branch_id[]" id="branch_id[]" multiple required>
