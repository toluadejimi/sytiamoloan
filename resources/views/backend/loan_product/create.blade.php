			...
			<div class="card-body">
				<form method="post" class="validate" autocomplete="off" action="{{ route('loan_products.store') }}" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">{{ _lang('Loan Amount').' '.currency() }}</label>
						...
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">{{ _lang('Term') }}   (loan number of repayment)</label>
								<input type="number" class="form-control" name="term" value="4" readonly>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control auto-select" data-selected="{{ old('term_period','+1 month') }}" name="term_period" id="term_period" required>
									<option	<option value="+1 week">{{ _lang('Weekly') }}</option>
									<!--<option value="+1 month">{{ _lang('Day') }}</option>-->
