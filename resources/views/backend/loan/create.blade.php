					...
					<div class="row">
                        ...
                        <div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control auto-select select2" data-selected="{{ old('branch_id') }}" name="branch_id" required>
						...
						<!--		<select class="form-control auto-select" data-selected="{{ old('currency_id') }}" name="currency_id"  hidden>-->
						<!--			<option value="">{{ _lang('Select One') }}</option>-->
						...
						<!--		<input type="text" class="form-control datepicker" name="first_payment_date" value="{{ old('first_payment_date') }}" >-->
						<!--	</div>-->
						<!--</div>-->
						...
						<!--<div class="col-md-6">-->
						<!--	<div class="form-group">-->
						<!--		<label class="control-label">{{ _lang('Duration(Weeks)') }}</label>-->
						<!--		<select class="form-control auto-select" data-selected="{{ old('term') }}" name="duration" required>-->
						<!--			<option value="">{{ _lang('Select One') }}</option>-->
						<!--			@foreach(get_table('loan_products',array('status='=>'1')) as $loan )-->
						<!--				<option value="{{ $loan->term }}">{{ $loan->name }} {{ $loan->term }} (Weeks)</option>-->
						<!--			@endforeach-->
						<!--		</select>-->
						<!--	</div>-->
						<!--</div>-->
