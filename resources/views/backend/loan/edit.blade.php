					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control auto-select select2" data-selected="{{ $loan->loan_product_id }}" name="loan_product_id" >
						...
						<!--		<input class="form-control 2" value="{{ $loan->borrower->first_name }}" name="borrower_id" id="borrower_id" >-->
						...
						<!--	<div class="col-md-6">-->
						<!--	<div class="form-group">-->
						<!--		<label class="control-label">{{ _lang('Loan Payment Date') }}</label>-->
						<!--		<input type="text" class="form-control " name="first_payment_date" value="{{ $loan->getRawOriginal('first_payment_date') }}"  >-->
						<!--	</div>-->
						<!--</div>-->

						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">{{ _lang('Disbusment Date') }}</label>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control float-field" name="applied_amount" value="{{ $loan->applied_amount }}"  >
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" class="form-control float-field" name="late_payment_penalties" value="{{ $loan->late_payment_penalties }}"  >
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<a href="{{ route('loans.show', $loan['id']) }}" class="btn btn-primary"><i class="bi bi-eye-fill"></i> View Loan</a>
							</div>
							<div class="form-group">
