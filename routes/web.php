...
Route::middleware(['install'])->group(function () use ($email_verification, $allow_signup) {
    ...
    Route::group(['middleware' => $email_verification == 'enabled' ? ['auth', 'verified'] : ['auth']], function () {
        ...
        //Profile Controller
        Route::post('manager_request', [LoanController::class,'manager_request'])->name('manager_request');
        Route::post('manager_repayment', [LoanController::class,'manager_repayment'])->name('manager_repayment');
        Route::get('Loans/manager_repayment', 'LoanController@manager_repayments')->name('loans.manager_repayments');
        Route::get('Loans/uncompleted', 'LoanController@uncompleted')->name('loans.uncompleted');
        Route::post('Loans/manager_repayment', 'LoanController@manager_repayment')->name('loans.manager_repayment');
        Route::get('Loans/manager_request_view', 'LoanController@manager_request_view')->name('loans.manager_request_view');
        Route::get('Loans/{id}/managerEdit', 'LoanController@managerEdit')->name('loans.managerEdit');
        Route::get('Loans/{id}/repaymentEdit', 'LoanController@repaymentEdit')->name('loans.repaymentEdit');
        Route::post('Loans/managerUpdate', 'LoanController@managerUpdate')->name('loans.managerUpdate');
        Route::delete('Loans/managerDestroy/{id}', 'LoanController@managerDestroy')->name('loans.managerDestroy');
         Route::delete('Loans/repayDestroy/{id}', 'LoanController@repayDestroy')->name('loans.repayDestroy');
        Route::get('loans/repayapproved/{id}', 'LoanController@repayapproved')->name('loans.repayapproved');
        Route::get('loans/mapproval/{id}', 'LoanController@mapproval')->name('loans.mapproval');
        Route::get('loans/mcompleted/{id}', 'LoanController@mcompleted')->name('loans.mcompleted');
        
        Route::post('Loans/manager_list', 'LoanController@manager_list')->name('loans.manager_list');
        ...
        Route::group(['middleware' => ['admin'], 'prefix' => 'admin'], function () {
            ...
            //Route::get('/reports', 'ReportController@search')->name('search');
        ...
        Route::group(['middleware' => ['permission'], 'prefix' => 'admin'], function () {
            ...
            //Send SMS
            Route::post('users/send', 'SMSController@send')->name('users.send');
            ...
            Route::resource('loans/pend', 'LoanController');
            Route::get('sort/pending', [LoanController::class, 'pending'])->name('sort.pending');
            Route::get('sort/approved', [LoanController::class, 'approved'])->name('sort.approved');
            // //Route::post('loans/get_table_data', 'LoanController@get_table_data');
            
            
             Route::get('reports/afo', [ReportController::class, 'afo'])->name('reports.afo');
                         Route::get('user/export', 'UserController@exports')->name('users.export_alluser');
            //   Route::get('user/export', [UserController::class, 'exports'])->name('user.export');
             Route::post('reports/quary', [ReportController::class, 'quaryafosdata'])->name('reports.quaryafosdata');
            ...
            Route::get('loans/completed/{id}', 'LoanController@completed')->name('loans.completed');
            Route::get('loans/paid/{id}', 'LoanController@paid')->name('loans.paid');
            Route::get('loans/reject/{id}', 'LoanController@reject')->name('loans.reject');
            Route::get('loans/disapproved/{id}', 'LoanController@disapproved')->name('loans.disapproved');
            Route::get('loans/download', 'LoanController@download')->name('loans.download');
            // Route::resource('loans', 'LoanController');
            Route::get('index', 'loanController@search')->name('search');
            

            Route::resource('reports', 'ReportController');
            //Route::post('reports', 'ReportController');
            //Route::get('reports', 'ReportController@index');
            //  Route::get('reports/afo', 'ReportController@afo');
