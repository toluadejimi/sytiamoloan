...
class LoanCalculator {
    ...
    public function get_flat_rate() {
        ...
        //$this->payable_amount = $this->apply_amount;
        ...
        $amount_to_pay    = $principle_amount;
        ...
        $break_down_amount = $this->apply_amount;

        $data = array();
        for ($i = 0; $i < $this->term; $i++) {
            //$balance = $balance - $amount_to_pay;
            $break_down_amount = $break_down_amount - $principle_amount;
            $data[]  = array(
                'date'             => $date,
